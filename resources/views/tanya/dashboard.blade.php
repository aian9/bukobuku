                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card text-left">
                                <div class="card-body">
                                    <div class="">
                                        <h1 class="mb-3">18812</h1>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>
                                                <h5 class="mb-0">Customers</h5>
                                                <small>800 New Customers</small>
                                            </span>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>
                                                ...
                                                <small>1000 Daily Orders</small>
                                            </span>
                                            <i class="fa fa-chart-pie big-icon" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="card text-left">
                                <div class="card-body">
                                    <div class="">
                                        <h1 class="mb-3">8812</h1>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>
                                                <h5 class="mb-0">Delivery</h5>
                                                <small>325 Delivered Orders</small>
                                            </span>
                                            <i class="fa fa-car big-icon" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="card text-left">
                                <div class="card-body">
                                    <div class="">
                                        <h1 class="mb-3">10203</h1>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>
                                                <h5 class="mb-0">Verified</h5>
                                                <small>1000 Verified User</small>
                                            </span>
                                            <i class="fa fa-user-check big-icon" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
