...
@section('content')
    ...
    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Silakan verifikasi Password Baru kamu dengan cara klik tombol di bawah ini!</p>
